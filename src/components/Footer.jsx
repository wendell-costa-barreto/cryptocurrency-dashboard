...
export default function Footer() {
    return (
        ...
        <footer className="bg-gray-300 shadow-sm dark:bg-gray-800 w-full mt-[4%] mb-[1em]">
            <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Made with Next.js by <Link target="_blank" href="https://github.com/wendell-costa-barreto" className="hover:underline text-blue-600">Wendell Costa</Link>
                </span>
